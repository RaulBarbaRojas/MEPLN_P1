...
if __name__ == '__main__':
    ...
    with open('assets/apartado_a/INPUT_RAW_espanol.txt', mode = 'r', encoding = 'utf-8') as archivo_entrada_espanol:
    ...
    with open('assets/apartado_a/INPUT_RAW_espanol_processed.txt', mode = 'w') as archivo_entrada_procesada_espanol:
        archivo_entrada_procesada_espanol.write(entrada_espanol)

    start_time = time.perf_counter()
    etiquetas_espanol = etiquetador_espanol(entrada_espanol)
    end_time = time.perf_counter()
    with open('out/apartado_a/OUTPUT_RAW_espanol.txt', mode = 'w', encoding='utf-8') as archivo_salida_espanol:
